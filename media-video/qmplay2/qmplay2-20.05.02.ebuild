...
IUSE="avdevice +audiofilters +alsa cdio cuvid dbus +extensions
	gme inputs libass modplug notifications opengl portaudio pulseaudio 
	sid shaders vaapi vdpau +videofilters visualizations vulkan xv"
...
src_configure() {
	local mycmakeargs=(
		...
		-DQMVK_FIND_VULKAN=$(usex vulkan)
		-DUSE_GLSLC=$(usex shaders)
		-DUSE_XVIDEO=$(usex xv)
		 -DFIND_HWACCEL_DRIVERS_PATH=true
